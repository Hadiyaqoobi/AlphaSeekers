  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      <button
        ...
        className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-sm transition-all ${
          liked
            ...
            : "bg-dark-50 text-ink-soft hover:bg-rose-50 hover:text-rose-600 border border-line"
        }`}
      >
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-sm bg-dark-50 text-ink-soft hover:bg-dark-100 border border-line transition-colors"
      >
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-sm bg-dark-50 text-ink-soft hover:bg-green-50 hover:text-green-700 border border-line transition-colors"
      >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-medium text-sm bg-dark-50 text-ink-soft hover:bg-sky-50 hover:text-sky-700 border border-line transition-colors"
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
