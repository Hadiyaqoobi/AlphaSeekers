        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            ...
            <motion.div
              ...
              animate="visible"
              variants={fadeInUp}
              className="inline-flex items-center gap-2.5 rounded-full bg-white/80 backdrop-blur-sm border border-brand-200/60 px-5 py-2.5 shadow-sm mb-8"
            >
          ...
          <div className="relative lg:ml-auto">
            ...
            <motion.div
              ...
              animate="visible"
              variants={scaleIn}
              className="absolute -bottom-6 -left-4 sm:left-4 bg-white rounded-2xl shadow-xl shadow-gray-900/10 border border-line-soft px-5 py-4 flex items-center gap-4 z-10 float-badge"
            >
